...
export const translations: Record<Locale, Dict> = {
  ...
  'pt-BR': {
    ...
    'issue.aiTitle': '✨ IA',
    'issue.aiReview': '🔎 REVISAR (INVEST)',
    'issue.aiReviewing': 'REVISANDO...',
    'issue.aiGenTests': '🧪 GERAR TESTES NO JIRA',
    'issue.aiGenerating': 'GERANDO...',
    'issue.aiCoverage': '📊 COBERTURA',
    'issue.aiCovering': 'ANALISANDO...',
    'issue.aiCoverageLabel': 'cobertura dos critérios de aceite',
    'issue.aiPostComment': 'comentar a revisão no Jira',
    'issue.aiError': 'Falha na ação de IA',
    'issue.aiGaps': 'Gaps',
    'issue.aiRisks': 'Riscos',
    'issue.aiMissingCriteria': 'Critérios faltantes',
    'issue.aiSubtasksSummary': '{generated} casos gerados → {created} subtarefas criadas',
  ...
  'en-US': {
    ...
    'issue.aiTitle': '✨ AI',
    'issue.aiReview': '🔎 REVIEW (INVEST)',
    'issue.aiReviewing': 'REVIEWING...',
    'issue.aiGenTests': '🧪 GENERATE TESTS IN JIRA',
    'issue.aiGenerating': 'GENERATING...',
    'issue.aiCoverage': '📊 COVERAGE',
    'issue.aiCovering': 'ANALYZING...',
    'issue.aiCoverageLabel': 'acceptance criteria coverage',
    'issue.aiPostComment': 'post review as Jira comment',
    'issue.aiError': 'AI action failed',
    'issue.aiGaps': 'Gaps',
    'issue.aiRisks': 'Risks',
    'issue.aiMissingCriteria': 'Missing criteria',
    'issue.aiSubtasksSummary': '{generated} cases generated → {created} subtasks created',
